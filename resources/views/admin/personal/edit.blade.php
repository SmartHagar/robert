            ...
            <div class="col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                        <form class="js-validation" action="{{ route('personal.update', $data->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <!-- Regular -->
                            <div class="row items-push">
                                    ...
                                    <select class="tom-select" id="val-jabatan" name="jabatan_id" required>
                                        ...
                                        @foreach ($jabatan as $item)
                                            <option value="{{ $item->id }}"
                                                @if ($data->jabatan_id == $item->id) selected @endif>{{ $item->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                        ...
                                        <div class="space-x-2">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="Laki-laki" name="jenkel"
                                                    value="Laki-Laki" @if ($data->jenkel == 'Laki-Laki') checked @endif>
                                                <label class="form-check-label" for="Laki-laki">Laki-Laki</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" id="Perempuan" name="jenkel"
                                                    value="Perempuan" @if ($data->jenkel == 'Perempuan') checked @endif>
                                ...
                                <div class="mb-4 col-md-4">
                                    ...
                                    <select class="form-select" id="val-agama" name="agama" required>
                                        ...
                                        <option value="Kristen Protestan" @if ($data->agama == 'Kristen Protestan') selected @endif>
                                            Kristen Protestan</option>
                                        <option value="Katolik" @if ($data->agama == 'Katolik') selected @endif>Katolik
                                        </option>
                                        <option value="Islam" @if ($data->agama == 'Islam') selected @endif>Islam
                                        </option>
                                        <option value="Hindu" @if ($data->agama == 'Hindu') selected @endif>Hindu
                                        </option>
                                        <option value="Budha" @if ($data->agama == 'Budha') selected @endif>Budha
                                        </option>
                                        <option value="Konghucu" @if ($data->agama == 'Konghucu') selected @endif>Konghucu
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-4 col-md-4">
                                    <label class="form-label" for="val-tanggal_lahir">Tanggal lahir <span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="form-control" id="val-tanggal_lahir"
