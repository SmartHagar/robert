            ...
            <div class="col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-header block-header-default">
                        ...
                        <div>
                            <a href="{{ route('honorer.create') }}" class="btn btn-secondary float-end">Tambah Data</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-muted d-flex justify-content-around">
                                                {{-- edit --}}
                                                <a class="text-warning" href="{{ route('honorer.edit', $item->id) }}">
                                                    <i class="fa-solid fa-pencil"></i>
                                                </a>
                                                {{-- hapus --}}
                                                <span class="text-danger hapus" role="button" title="Hapus"
                                                    data-url="honorer" data-id="{{ $item->id }}">
