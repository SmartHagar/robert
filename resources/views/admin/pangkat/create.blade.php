            ...
            <div class="col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content">
                        <form class="js-validation" action="{{ route('pangkat.store') }}" method="POST">
                            @csrf
                            <!-- Regular -->
                            <div class="row items-push">
                                <div class="mb-4 col-md-4">
                                    ...
                                    <select class="form-select" id="val-golongan" name="golongan" required>
                                        ...
                                        <option value="I (Juru)">I (Juru)</option>
                                        <option value="II (Pengatur)">II (Pengatur)</option>
                                        <option value="III (Penata)">III (Penata)</option>
                                        <option value="IV (Pembina)">IV (Pembina)</option>
                                    </select>
                                </div>
