            ...
            <div class="col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    <div class="block-header block-header-default">
                        ...
                        <div>
                            <a href="{{ route('pegawai.create') }}" class="btn btn-secondary float-end">Tambah Data</a>
                        </div>
                    </div>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-muted d-flex justify-content-around">
                                                {{-- edit --}}
                                                <a class="text-warning" href="{{ route('pegawai.edit', $item->id) }}">
                                                    <i class="fa-solid fa-pencil"></i>
                                                </a>
                                                {{-- hapus --}}
                                                <span class="text-danger hapus" role="button" title="Hapus"
                                                    data-url="pegawai" data-id="{{ $item->id }}">
