            ...
            <div class="col-xl-12">
                <div class="block block-rounded h-100 mb-0">
                    ...
                    <div class="block-content text-muted">
                        <p>
                            Silahkan menambah, menghapus dan mengubah data pegawai
                        </p>
                    </div>
                    {{-- form --}}
                    <div class="block-content">
                        <form class="js-validation" action="{{ route('pegawai.store') }}" method="POST">
                            @csrf
                            <!-- Regular -->
                            <div class="row items-push">
                                ...
                                <div class="mb-4 col-12">
                                    ...
                                    <select class="tom-select" id="val-pangkat" name="pangkat_id" required>
                                        ...
                                        @foreach ($pangkat as $item)
                                            <option value="{{ $item->id }}">{{ $item->golongan }}-{{ $item->pangkat }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
